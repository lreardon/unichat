...
class Settings(BaseSettings):
    ...
    # Database
    database_url: str = "postgresql+asyncpg://unichat:unichat@localhost:5432/unichat"
    database_url_sync: str = "postgresql+psycopg://unichat:unichat@localhost:5432/unichat"
